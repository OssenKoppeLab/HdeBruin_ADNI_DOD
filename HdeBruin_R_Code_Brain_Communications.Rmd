...
# load relevant data files for supplementary table 1 (PTSD status was previously combined with PET data, so already present)
...
#### now relevel with TBI status as factor for post hoc analyses - code not included here ####
